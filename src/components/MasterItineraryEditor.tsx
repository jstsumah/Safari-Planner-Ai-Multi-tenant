...
import { 
  ...
  Search, Check, Layout, FileCheck, User
} from 'lucide-react';
            ...
            <div className="p-6 border-b border-safari-100 flex justify-between items-center bg-safari-50">
              ...
              <div className="flex items-center gap-4">
                <button 
                  onClick={() => fileInputRef.current?.click()}
                  disabled={isUploading}
                  className="px-4 py-2 bg-safari-800 text-white rounded-lg font-black uppercase text-[10px] tracking-widest flex items-center gap-2 hover:bg-safari-900 transition-all shadow-md"
                >
                  <UploadCloud size={14} /> {isUploading ? 'Uploading...' : 'Upload New'}
                </button>
